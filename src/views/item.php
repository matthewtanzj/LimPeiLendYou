                ...
                <div class="col-lg-5">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <p><b>Owner:</b> <?php echo $item['owner'] ?><a href="index.php?page=message&amp;item=<?php echo $item['item_name']?>&amp;owner=<?php echo $item['owner']?>" class="btn btn-default col-lg-offset-7 submit-button">Send Message</a></p>
